...
SINGLE = {
  ...
  'egg':      'a wobbly golden egg-custard character caught mid-jiggle, one single happy face, smooth glossy swirl leaning sideways',
...
PAIRS = {
  ...
  'banana+rainbow': 'a slim banana character sleeping peacefully on its side on top of a small rainbow arc, curled like a crescent moon, dream sparkles floating up',
